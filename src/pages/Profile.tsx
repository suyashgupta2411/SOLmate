...
export default function Profile() {
  ...
  const isAdmin = userProfile?.connectedWallet === ADMIN_WALLET;
  ...
  const achievements = [
    {
      ...
      earned: userStats.groupsJoined > 0,
    },
    {
    ...
    {
      name: "Helper",
      description: "Sent 10 tips to other members",
      earned: userStats.totalTips >= 10,
    },
    {
      name: "Popular Choice",
      description: "Received 50 tips from peers",
      earned: userStats.totalTips >= 50,
    },
    {
      name: "Group Leader",
      description: "Created a successful study group",
      earned: false,
    },
    {
  ...
  const handleResetDatabase = async () => {
    if (!isAdmin) return;
    const collections = ["users", "studyGroups", "proposals"];
